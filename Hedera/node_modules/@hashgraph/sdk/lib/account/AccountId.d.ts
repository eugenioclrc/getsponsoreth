...
export default class AccountId {
     ...
     */
    constructor(props: number | Long | import("../EntityIdHelper").IEntityId, realm?: (number | Long) | undefined, num?: (number | Long) | undefined, aliasKey?: (PublicKey) | undefined, aliasEvmAddress?: (EvmAddress) | undefined);
    shard: Long.Long;
    realm: Long.Long;
    num: Long.Long;
    aliasKey: PublicKey | null;
    aliasEvmAddress: EvmAddress | null;
    /**
     * @type {string | null}
     */
