 ...
 */
class ContractEvmTransaction extends _Transaction.default {
  /**
   * @param {object} [props]
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    if (transaction.callData != null) {
      ethereumData = _FileId.default._fromProtobuf(transaction.callData);
    } else if (transaction.ethereumData != null) {
      ethereumData = transaction.ethereumData;
    }

    return _Transaction.default._fromProtobufTransactions(new ContractEvmTransaction({
      ethereumData,
      maxGas: transaction.maxGasAllowance != null ? _long.default.fromValue(transaction.maxGasAllowance) : undefined
  ...
  setMaxGas(maxGas) {
    ...
    this._maxGas = typeof maxGas === "number" ? _long.default.fromNumber(maxGas) : maxGas;
    return this;
  }
  /**
   * @param {Client} client
  ...
  _makeTransactionData() {
    return {
      ethereumData: this._ethereumData instanceof _FileId.default ? null : this._ethereumData,
      callData: this._ethereumData instanceof _FileId.default ? this._ethereumData._toProtobuf() : null,
...
exports.default = ContractEvmTransaction;

_Transaction.TRANSACTION_REGISTRY.set("ethereumTransaction", // eslint-disable-next-line @typescript-eslint/unbound-method
