...
export default class ContractUpdateTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): ContractUpdateTransaction;
    /**
     * @param {object} props
     ...
     */
    protected override _makeTransactionData(): HashgraphProto.proto.IContractUpdateTransactionBody;
}
