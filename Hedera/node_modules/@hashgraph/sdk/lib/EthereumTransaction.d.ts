...
export default class EthereumTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): EthereumTransaction;
    /**
     * @param {object} [props]
    ...
    constructor(props?: {
        ...
        maxGasAllowance?: string | number | import("long").Long | import("bignumber.js").default | Hbar | undefined;
    } | undefined);
    /**
     * @private
     * @type {?Uint8Array}
     ...
     * @returns {this}
     */
    setCallData(callData: FileId): this;
    /**
     * @returns {?Hbar}
     */
