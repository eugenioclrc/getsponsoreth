...
declare namespace Status {
    ...
    const SchedulePendingExpiration: Status;
    const ContractIsTokenTreasury: Status;
    const ContractHasNonZeroTokenBalances: Status;
    const ContractExpiredAndPendingRemoval: Status;
    const ContractHasNoAutoRenewAccount: Status;
    const PermanentRemovalRequiresSystemInitiation: Status;
}
