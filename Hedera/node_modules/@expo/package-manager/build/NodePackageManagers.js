...
exports.getModulesPath = exports.createForProject = exports.YarnPackageManager = exports.NpmPackageManager = exports.isUsingYarn = exports.DISABLE_ADS_ENV = void 0;
...
function isUsingYarn(projectRoot) {
    const workspaceRoot = (0, nodeWorkspaces_1.findWorkspaceRoot)(projectRoot);
    if (workspaceRoot) {
